...
*Defined in [packages/api-derive/src/session/eraProgress.ts:14](https://github.com/jak-pan/api/blob/bc94e95733/packages/api-derive/src/session/eraProgress.ts#L14)*
